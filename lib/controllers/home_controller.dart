...
class HomeController extends GetxController with GetTickerProviderStateMixin {
  ...
  void onInit() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      DirectionsService.init('AIzaSyDIQQ7PPMh1M3lDmw2yB_9Mm71qLno-rQc');
    });
  ...
  getTotalDistanceAndTime(LatLng destination) async {
    ...
    var response = await dio.get(
        "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=$origin&destinations=$destinations&key=AIzaSyDIQQ7PPMh1M3lDmw2yB_9Mm71qLno-rQc");
